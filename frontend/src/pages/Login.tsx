...
import { Eye, EyeOff, ChevronLeft, Mail, CheckCircle2 } from "lucide-react";
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
          {verificationRequired ? (
            <div className="text-center py-4 space-y-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900">{t("auth.verifyEmailTitle", "Verify your email")}</h2>
              <p className="text-gray-600">
                {t("auth.verifyEmailMessage", "We've sent a verification link to your email. Please click the link to confirm your account.")}
              </p>
              <div className="pt-4">
                <Button
