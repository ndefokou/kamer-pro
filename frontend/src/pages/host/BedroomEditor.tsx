        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-4xl mx-auto px-6 py-8">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-12 text-center bg-white mb-6">
                    ...
                    >
                        {totalPhotos === 0 ? t('host.editor.addPhotos', 'Add photos') : t('photos.addMorePhotos', 'Add more photos')}
                    </button>

                    {pendingPhotos.length > 0 && (
                        <p className="text-sm text-gray-500 mt-3">
                            {pendingPhotos.length} {pendingPhotos.length !== 1 ? t('photos.photosPlural', 'photos') : t('photos.photoSingular', 'photo')} {t('photos.readyToUpload', 'ready to upload')}
                        </p>
                    )}
                </div>
                ...
                {pendingPhotos.length > 0 && (
                    <div className="flex justify-end gap-3">
                        ...
                        >
                            {uploading ? t('common.saving', 'Saving...') : t('common.savePhotosCount', 'Save {{count}} {{unit}}', { count: pendingPhotos.length, unit: pendingPhotos.length !== 1 ? t('photos.photosPlural', 'photos') : t('photos.photoSingular', 'photo') })}
                        </button>
                    </div>
                )}
            </div>
